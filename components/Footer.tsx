        ...
        <footer className="footer py-16">
            <div className="w-4/5 max-w-6xl mx-auto flex flex-col items-center">
                <div className="flex gap-4">
                    <Link href="https://instagram.com/poolesville_hacks">
                        <Icon
                            path={mdiInstagram}
                            size={1.2}
                            title="instagram"
                    ...
                    <Link href="mailto:hello@poolesvillehacks.tech">
                        <Icon path={mdiEmail} size={1.2} title="email" />
                    </Link>
                    <Link href="https://discord.gg/ghqvB9adX5">
